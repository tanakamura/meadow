...
void
get_root (unsigned char *program, unsigned char *result)
{
...
#ifdef SPECIAL_EXEC
BOOL APIENTRY
startdialog_wndproc (HWND hwnd, UINT message, UINT wParam, LONG lParam)
{
  switch (message)
    {
    case WM_INITDIALOG:
      CheckRadioButton (hwnd,
			IDC_RADIOMEADOW, IDC_RADIOMULE, IDC_RADIOMEADOW);
      return TRUE;
